...
public class SoupRenderTypes extends RenderType {
	...
	public static class SoupTextureStateShard extends EmptyTextureStateShard {
		private static final ResourceLocation DEFAULT_SOUP = Constants.modLoc("textures/soup/default_soup.png");
